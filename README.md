...
The fallback environment now includes textured walls/floor, a multi-part terminal prop, terminal glow flicker, and spatial ambient audio so test runs feel closer to the intended office atmosphere.
