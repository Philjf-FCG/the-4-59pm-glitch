...
The fallback environment now includes textured walls/floor, a multi-part terminal prop, terminal glow flicker, spatial ambient audio, pressure-reactive room lighting/signage, and in-world object/exit/directive displays so test runs feel closer to the intended office atmosphere.
